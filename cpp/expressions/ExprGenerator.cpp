...
int ExprGenerator::reduceOperationsBy(SubExprLocation subExprLocation)
{
	...
	{
		case SubExprLocation::LEFT : return 1;
		case SubExprLocation::RIGHT : return 1;
		case SubExprLocation::BOTH : return 2;
		default : return 0;
	}
}
...
SubExprLocation ExprGenerator::getEmptyTokenLocations(int operationsLeft)
{
	...
	{
		case 0 : return SubExprLocation::NEITHER;
		case 1 : return SubExprLocation::NEITHER;
		case 2 : 
